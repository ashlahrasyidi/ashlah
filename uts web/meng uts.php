...
<body background="GEISHA 1.png">
    <div class="wrap">
        ...
        <div class="content"><center>
            ...
            <h2>WELCOME</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Muhammad Ashlah Rasyidi</td></tr>
                <tr><td>NIM</td><td>:</td><td>11180910000045</td></tr>
                </table>
                <p>Terima Kasih</p> 
            </form>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=persegiPanjang">
                <table>
                  <tr><td> Panjang Persegi Panjang</td><td>:</td><td><input type="text" name="panjang"></td></tr>
                  <tr><td> Lebar Persegi Panjang</td><td>:</td><td><input type="text" name="lebar"></td></tr>  
                </table>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=segitiga">
                <table>
                  <tr><td> Alas Segitiga</td><td>:</td><td><input type="text" name="alas"></td></tr>
                  <tr><td> Tinggi Segitiga</td><td>:</td><td><input type="text" name="tinggi"></td></tr>  
                </table>
                <input type="reset" name="reset" value="Reset"> <input type="submit" name="submit" value="Submit"> 
            ...
            <?php
                ...
                $query = mysqli_query($connection,"SELECT * FROM mahasiswa2");
                ?>
            ...
            { 
              $tinggi=$_POST['tb'];
                ...
                $ideal=($tinggi-100)-$persen;
                    ...
                    {
                    echo "<p>Berat Badan Anda Ideal, Pertahankan Okee :).</p>";
                    }else
                    {
                    echo "<p>Berat Badan Anda Belum Ideal, Ayo Tingkatkan Usahamu! .</p>";
                    }
                ...
                $tbtLahir;
                echo "<table>";
                echo "<tr><td>PENDAFTARAN SUKSES</tr></td>";
                ...
                {
                  $hasil = $panjang*$lebar;
                  echo "<p>Panjang Persegi Panjang = <b>".$panjang."</b> </p>";
                  echo "<p>Lebar Persegi Panjang = <b>".$lebar."</b> </p>";
                  echo "<p>Luas Persegi Panjang = <b>".$hasil."</b> </p>";
                }
                ...
                function luas_segitiga($alas,$tinggi)
                {
                  ...
                  echo "<p>Luas Segitiga = <b>".$hasil."</b> </p>";
                }
                  $alas = $_POST['alas'];
                  $tinggi = $_POST['tinggi'];
